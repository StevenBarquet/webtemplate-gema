...
<h3>Mecanismos Alternos de Solución de Conflictos en el ámbito constitucional.</h3>
<p>El 18 de junio de 2008, en el contexto de la reforma penal más importante en nuestro país, se reconoció en el artículo 17 constitucional a los Mecanismos Alternativos de Solución de Conflictos al establecer que “Las leyes preverán mecanismos alternativos de solución de controversias. En la materia penal regularán su aplicación, asegurarán la reparación del daño y establecerán los casos en los que se requerirá supervisión judicial.”  Mas tarde, el 29 de diciembre de 2014 se publicó en el Diario Oficial de la Federación el Decreto por el que se expide la Ley Nacional de Mecanismos Alternativos de Solución de Controversias en Materia Penal con lo que se daría cumplimiento a la cláusula constitucional, exclusivamente por lo que refiere a esta materia. Finalmente, el 5 de febrero de 2017 se publicó el decreto por el que se otorga al Congreso de la Unión, la facultad para expedir la ley general que fije los principios y bases en materia de mecanismos alternativos de solución de controversias, con excepción de la materia penal. 

Actualmente, el Congreso de la Unión, asistido por un grupo de expertos en la materia, trabaja para la construcción de un cuerpo de principios y normas que le darán soporte a esta Ley General. Con la expedición de esta ley quedará configurado a cabalidad el Sistema de Justicia Alternativa más amplio y progresista en América Latina. 

De la lectura de la siguiente tabla, puede apreciarse que México no es el único país que ha reconocido en su norma fundamental estos métodos o mecanismos, pero sí resulta evidente que ningún sistema latinoamericano logra la amplitud ni el potencial otorgado por nuestra Carta Magna, como puede apreciarse en el siguiente cuadro.</p>
<img>
<p>En nuestro país, la implementación de estos mecanismos es anterior al reconocimiento constitucional. Me refiero a la aplicación de los modelos de conciliación y arbitraje en las materias laboral, de relaciones de consumo, en la prestación de servicios de salud y respecto de usuarios de servicios financieros.</p>
<h3>Algunas reflexiones en torno a la aplicación de los Mecanismos Alternos de Solución de Conflictos.</h3>
<p>Es preciso tener presente que los Mecanismos Alternos de Solución de Controversias son precisamente herramientas aplicables a la resolución de conflictos de distinta naturaleza que tienen, en todos los casos, una vocación pacificadora de las relaciones y la sociedad.


No obstante, debo precisar que el sistema normativo nacional, determina con claridad cuáles son los bienes relevantes y protegidos, así como las relaciones jurídicas que se desprenden de las leyes.


Podemos entender que el sistema jurídico mexicano actual permite la aplicación de mecanismos alternos de solución de conflictos en la mayoría de las relaciones interpersonales, entre personas y administración pública o incluso entre entidades de la administración pública. En sentido negativo, señala espacios que son claramente indisponibles por su relevancia constitucional, como podemos apreciar en el siguiente gráfico:
</p><img><p>De la revisión realizada los instrumentos normativos vigentes, podemos encontrar el reconocimiento e implementación legal de los Mecanismos Alternos de Solución de Controversias en los siguientes ámbitos.
</p>
<h3>Mecanismos Alternos de Solución de Conflictos en el ámbito internacional.</h3>
<p>En materia internacional regularmente son diversos instrumentos los que han habilitado la aplicación de Mecanismos Alternos de Solución de Controversias para resolver conflictos entre sujetos de derecho internacional o entre particulares y naciones. A continuación se presenta una relación de los principales instrumentos que vinculan a México en sus relaciones internacionales.</p>
<img>
<h3>Mecanismos Alternos de Solución de Conflictos en las Leyes Federales</h3>
<p>A partir del Consenso de Washington y con la creciente implementación de los preceptos de la Nueva Gestión Pública, pudimos apreciar una mayor liberalización en la gestión y administración pública mexicana. La aplicación de subsidiariedad en la oferta de determinados servicios generó cambios significativos en la conflictología de la materia. Las pautas son claras: menor intervención del estado, mayor participación ciudadana para la construcción de una nueva democracia y una creciente necesidad de eficiencia y eficacia.


Acudimos así al nacimiento de la conciliación y el arbitraje en el ámbito federal y su instrumentalización mediante la creación de instituciones como la Procuraduría de la Defensa del Consumidor, la Comisión Nacional de Arbitraje Médico, la Comisión Nacional para la Defensa de los Usuarios de Servicios Financieros y, poco después, a la Procuraduría de la Defensa del Contribuyente.  Estos institutos conforman los cimientos sobre los que se ha expandido el sistema de Mecanismos Alternos de Solución de Controversias en el ámbito federal. Hoy podemos identificarlos en diversos ordenamientos, como puede observarse en la siguiente tabla:
</p><img><h3>Mecanismos Alternos de Solución de Conflictos en las leyes de las entidades federativas.</h3><p>La tendencia expansiva de aplicación de los mecanismos alcanzó con gran facilidad a la justicia cotidiana. En materia civil, mercantil y familiar observamos que, desde el 2004, las entidades federativas han legislado en materia de justicia alternativa y sus mecanismos. La consolidación de los sistemas locales de justicia alternativa en justicia cotidiana puede apreciarse con toda claridad en la siguiente cronología.</p><img>
<p>Actualmente, los sistemas locales de justicia alternativa, bajo la modalidad de Centros o Institutos dependientes de los poderes judiciales locales, son el ejemplo por excelencia de la eficiencia y potencia en la aplicación de estos mecanismos. Si bien no es su finalidad primaria, resultan evidentes los efectos que tienen en cuanto a despresurización de los tribunales, pero sobre todo en cuanto a la garantía de acceso a la justicia de los ciudadanos.</p>
<br /><h3>Conclusión:</h3><p>Los Mecanismos Alternos de Solución de Conflictos son herramientas, procesos y métodos que permiten a las partes en conflicto, su gestión pacifica. 


En nuestro país estos mecanismos se han consolidado como una vía de acceso a la justicia distinta a la jurisdicción, nacional o internacional. En este sentido, como lo ha desarrollado la jurisprudencia y la doctrina, es un componente del Derecho Humano de Acceso a la Justicia que tiene la misma relevancia y dignidad constitucional que los procesos jurisdiccionales. 


El sistema jurídico mexicano permite su aplicación en las materias disponibles por señalamiento expreso de la Constitución, tratados internacionales o leyes federales y locales. Los principios, límites, procedimientos y resultados serán determinados en función del conflicto al que se aplique y de las disposiciones constitucionales y legales que rigen cada materia. Actualmente se encuentran legalmente habilitados e implementados en múltiples ramas del derecho, en distintos niveles. 
